...
BBoxesDataNode::BBoxesDataNode() : participant_(nullptr) , subscriber_(nullptr) , topic_(nullptr) , reader_(nullptr) , type_(new BBoxesDataPubSubType())
{}



BBoxesDataNode::~BBoxesDataNode()
{
...
bool BBoxesDataNode::init()
{
    DomainParticipantQos participantQos;
    participantQos.name("BBoxesDataNode");
    ...
    topic_ = participant_->create_topic("BBoxTopic", "BBoxesData", TOPIC_QOS_DEFAULT);
